          ...
          <main className="home-plan">
            ...
            <section>
              ...
              <p className="no-commit">Healthy just got easy! No commitment. </p>
                  ...
                  <div onClick={this.handleClickChange} id= "weekly-offer" className="weekly-offer"><p className="numbered">6</p><p className="numbered-week">per week</p><p className="numbered-cost"> $7.75 per cup</p></div>
                  <div  onClick={this.handleClickChanges} id= "weekly-offer" className="weekly-offer"><p className="numbered">9</p><p className="numbered-week">per week</p><p className="numbered-cost"> $6.75 per cup</p></div>
